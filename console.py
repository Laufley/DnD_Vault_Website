...
campaign_1 = Campaign("Eberron's collapse", "Fanasty", "Octavio", 6, 20, "for new players.", "https://flyinglizardstudio.com/wp-content/uploads/2018/02/ToA-E2.jpg")
campaign_2 = Campaign("God save the... Djin(?)", "Fantasy", "Sophie", 3, 8, "fight a malicious entity.", "https://static.wikia.nocookie.net/mana/images/7/79/Jinn_%28Children_of_Mana%29.png")
campaign_3 = Campaign("Zombies, Why not", "horror", "Steve", 8, 15, "How far can you survive?", "https://images.fineartamerica.com/images/artworkimages/mediumlarge/3/2-zombies-eat-brains-dont-worry-youre-safe-funny-the-perfect-presents.jpg")
campaign_4 = Campaign("Who killed father Toad?", "mystery", "Eva", 6, 15, "contains frogs and mistery", "https://cdn.custom-cursor.com/packs/5965/cute-frog-and-mushroom-pack.png")
campaign_5 = Campaign("The last sunset in Terra", "sci-fi", "Steve", 5, 20, "Play in the 41st Millennium.","https://cdn.jwplayer.com/v2/media/OwqBzsJc/poster.jpg?")
...
joint_7 = Player_history(player_7, campaign_1)
joint_8 = Player_history(player_8, campaign_4)
joint_9 = Player_history(player_9, campaign_2)
joint_10 = Player_history(player_10, campaign_3)
joint_11 = Player_history(player_11, campaign_5)
joint_12 = Player_history(player_12, campaign_4)
joint_13 = Player_history(player_13, campaign_5)
joint_13 = Player_history(player_14, campaign_4)
